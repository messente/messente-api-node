...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MessenteApi.DeliveryReportResponse();
  });
  ...
  describe('DeliveryReportResponse', function() {
    it('should create an instance of DeliveryReportResponse', function() {
      ...
      //var instance = new MessenteApi.DeliveryReportResponse();
      //expect(instance).to.be.a(MessenteApi.DeliveryReportResponse);
    });
