...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.WhatsappComponentType = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>WhatsappComponentType</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/WhatsappComponentType} The enum <code>WhatsappComponentType</code> value.
   */
