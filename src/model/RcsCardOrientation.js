...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.RcsCardOrientation = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>RcsCardOrientation</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/RcsCardOrientation} The enum <code>RcsCardOrientation</code> value.
   */
