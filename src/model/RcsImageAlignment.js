...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.RcsImageAlignment = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>RcsImageAlignment</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/RcsImageAlignment} The enum <code>RcsImageAlignment</code> value.
   */
