...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.WhatsappTemplateCategory = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>WhatsappTemplateCategory</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/WhatsappTemplateCategory} The enum <code>WhatsappTemplateCategory</code> value.
   */
