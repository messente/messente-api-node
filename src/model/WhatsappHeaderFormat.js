...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.WhatsappHeaderFormat = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Enum class WhatsappHeaderFormat.
   * @enum {}
   * @readonly
   */
  var exports = {
  ...
  /**
   * Returns a <code>WhatsappHeaderFormat</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/WhatsappHeaderFormat} The enum <code>WhatsappHeaderFormat</code> value.
   */
