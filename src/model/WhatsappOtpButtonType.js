...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.WhatsappOtpButtonType = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Enum class WhatsappOtpButtonType.
   * @enum {}
   * @readonly
   */
  var exports = {
  ...
  /**
   * Returns a <code>WhatsappOtpButtonType</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/WhatsappOtpButtonType} The enum <code>WhatsappOtpButtonType</code> value.
   */
