...
class WhatsAppCurrency {
     ...
     */
    constructor(fallbackValue, code, amount1000) { 
        
        WhatsAppCurrency.initialize(this, fallbackValue, code, amount1000);
    }
     ...
     */
    static initialize(obj, fallbackValue, code, amount1000) { 
