...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorCodeOmnichannel', 'model/ErrorTitleOmnichannel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ErrorCodeOmnichannel'), require('./ErrorTitleOmnichannel'));
  } else {
    // Browser globals (root is window)
    if (!root.MessenteApi) {
      root.MessenteApi = {};
    }
    root.MessenteApi.ErrorItemOmnichannel = factory(root.MessenteApi.ApiClient, root.MessenteApi.ErrorCodeOmnichannel, root.MessenteApi.ErrorTitleOmnichannel);
  }
}(this, function(ApiClient, ErrorCodeOmnichannel, ErrorTitleOmnichannel) {
  'use strict';
