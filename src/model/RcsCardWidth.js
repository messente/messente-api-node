...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.RcsCardWidth = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Returns a <code>RcsCardWidth</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/RcsCardWidth} The enum <code>RcsCardWidth</code> value.
   */
