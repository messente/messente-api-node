...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OneOfViberSMSWhatsApp'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OneOfViberSMSWhatsApp'));
  } else {
    // Browser globals (root is window)
    if (!root.MessenteApi) {
      root.MessenteApi = {};
    }
    root.MessenteApi.Omnimessage = factory(root.MessenteApi.ApiClient, root.MessenteApi.OneOfViberSMSWhatsApp);
  }
}(this, function(ApiClient, OneOfViberSMSWhatsApp) {
  'use strict';
   ...
   * @param messages {Array.<module:model/OneOfViberSMSWhatsApp>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('messages')) {
        obj['messages'] = ApiClient.convertToType(data['messages'], [OneOfViberSMSWhatsApp]);
      }
  ...
  /**
   * @member {Array.<module:model/OneOfViberSMSWhatsApp>} messages
   */
