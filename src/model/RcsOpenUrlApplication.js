...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MessenteApi.RcsOpenUrlApplication = factory(root.MessenteApi.ApiClient);
  }
  ...
  /**
   * Enum class RcsOpenUrlApplication.
   * @enum {}
   * @readonly
   */
  var exports = {
  ...
  /**
   * Returns a <code>RcsOpenUrlApplication</code> enum value from a Javascript object name.
   * @param {Object} data The plain JavaScript object containing the name of the enum value.
   * @return {module:model/RcsOpenUrlApplication} The enum <code>RcsOpenUrlApplication</code> value.
   */
