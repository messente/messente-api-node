...
class GroupResponseFields {
     ...
     */
    constructor(id, name, contacts_count) { 
        
        GroupResponseFields.initialize(this, id, name, contacts_count);
    }
     ...
     */
    static initialize(obj, id, name, contacts_count) { 
        obj['id'] = id;
        obj['name'] = name;
        obj['contactsCount'] = contacts_count;
    }
