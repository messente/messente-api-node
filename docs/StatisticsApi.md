...
let statisticsReportSettings = {"start_date":"2017-01-01","end_date":"2019-06-20","message_types":["sms"]}; // StatisticsReportSettings | Settings for statistics report
apiInstance.createStatisticsReport(statisticsReportSettings, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
